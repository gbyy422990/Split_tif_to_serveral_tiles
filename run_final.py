...
# [image index, y, x, channels]，transfer from [0,255] to [-0.5, 0.5].
...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    data_dir = 'training/'
    train_data_filename = data_dir + 'sat/'
    train_labels_filename = data_dir + 'map/'
    test_data_filename = data_dir + 'test/'
    ...
    for i in range(len(train_labels)):
        print('train labels step:',i)
        print('total step:',len(train_labels))
    ...
    fc1_weights = tf.Variable(  # fully connected, depth 512.
        tf.truncated_normal([int(IMG_PATCH_SIZE/4 * IMG_PATCH_SIZE/4 * 64), 512],     #生成张量的维度
                            stddev=0.1,
                            seed=SEED))
    ...
    def get_prediction_with_groundtruth(filename, image_idx):
        ...
        image_filename = filename + str(imageid) + ".png"
        img = mpimg.imread(image_filename)
    ...
    with tf.Session() as s:
        ...
        if RESTORE_MODEL:
            ...
            for iepoch in range(num_epochs):
                print('Num od epoch:',iepoch)
                print('Total epochs is:',num_epochs)
                ...
                for step in range (int(train_size / BATCH_SIZE)):
                    ...
                    if step % RECORDING_STEP == 0:
                        ...
                        print ('Minibatch error: %.3f%%' % error_rate(predictions,
                                                                     batch_labels))
                ...
                save_path = saver.save(s, "model0711.ckpt")
        ...
        for i in range(1, TRAINING_SIZE+1):
            ...
            Image.fromarray(pimg).save(prediction_training_dir + "0711final_prediction_" + str(i) + ".png")
            oimg = get_prediction_with_overlay(test_data_filename, i)
            oimg.save(prediction_training_dir + "0711final_overlay_" + str(i) + ".png")
